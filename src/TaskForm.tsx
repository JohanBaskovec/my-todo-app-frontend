...
export default function TaskForm(props: TaskFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="grid grid-cols-3 gap-2 max-w-xl">
      <Input name="name" form={form} setForm={setForm} />
